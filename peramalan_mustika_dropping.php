...
WHERE d.nama_toko = 'MUSTIKA, TOKO'  AND p.kode_produk = '$nama_produk' 
	...
	if ($_POST["submit"]="Ganti Alpha") {
		...
		if (($pesan_error === "") AND ($_POST["submit"]="Ganti Alpha")) {
			...
			if ($resultquery) {
				...
				header("Location: peramalan_mustika_dropping.php?pesan_sukses={$pesan_sukses}");
			}
			else {
			...
			<div class="jumbotron">
				...
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form action="peramalan_mustika_dropping.php" method="post" name="ubah_alpha" class="form-inline" onsubmit="return submitForm();">
