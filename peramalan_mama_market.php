...
$querysum = "SELECT SUM(jumlah_retur) FROM tb_retur1 WHERE nama_toko = 'mama market'";
$pesan_error = "";
	...
	if ($_POST["submit"]="Ganti Alpha") {
		...
		if (($pesan_error === "") AND ($_POST["submit"]="Ganti Alpha")) {
			...
			if ($resultquery) {
				...
				header("Location: peramalan_mama_market.php?pesan_sukses={$pesan_sukses}");
			}
			else {
			...
			<div class="jumbotron">
				...
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-8">
							<form action="peramalan_mama_market.php" method="post" name="ubah_alpha">
						...
						<script>
							...
							var dataFirst = {
								...
								var dataSecond = {
									...
									var speedData = {
										labels: [<?php
											$querybulan = "SELECT nama_toko, bln_thn, SUM(jumlah_retur) AS jumlah_retur
                                            FROM tb_retur1
                                            WHERE nama_toko = 'mama market'
                                            GROUP BY nama_toko, bln_thn
                                            ORDER BY bln_thn";
