...
if (isset($_POST["submit"])) {
    ...
    if (!$pesan_error) {
        ...
        $querytambah = "INSERT INTO tb_dropping (kode_dropping, kode_toko, nama_toko, kode_produk, bln_thn, jumlah_dropping) 
        VALUES ('$kode_dropping', '$kode_toko', '$nama_toko', '$kode_produk', '$bulan_tahun', '$data_aktual')";

        $resultquery = mysqli_query($koneksi, $querytambah);

        if ($resultquery) {
            $pesan_sukses = "Data dropping berhasil ditambahkan!";
...
<head>
    <meta charset="UTF-8">
    <title>Tambah Data dropping</title>
...
<body>
    ...
    <div class="content-container">
        <div class="container-fluid">
            <div class="jumbotron">
                <h2 style="margin-bottom: 25px;">Tambah Data Dropping</h2>
                <?php
                if ($pesan_error !== "") {
                ...
                ?>
                <form action="tambah_dropping.php" method="post" name="form1">
                    <div class="form-group">
                        <label for="kode_dropping">Kode dropping</label>
                        <input class="form-control" type="text" name="kode_dropping" required>
                    </div>
                    <div class="form-group">
