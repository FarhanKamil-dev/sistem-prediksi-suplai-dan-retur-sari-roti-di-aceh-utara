...
$querytampil = "SELECT nama_toko, bln_thn, SUM(jumlah_retur) AS jumlah_retur
FROM tb_retur1
...
$querysum = "SELECT SUM(jumlah_retur) FROM tb_retur1 WHERE nama_toko = '$nama_toko'";
$pesan_error = "";
	...
	if ($_POST["submit"]="Ganti Alpha") {
		...
		if (($pesan_error === "") AND ($_POST["submit"]="Ganti Alpha")) {
			...
			if ($resultquery) {
				...
				header("Location: peramalan_semua_toko.php?pesan_sukses={$pesan_sukses}");
			}
			else {
...
<head>
	<meta charset="UTF-8">
	<title>Prediksi Retur - Sari Roti</title>
	...
	<div class="content-container">
		<div class="container-fluid">
			...
			<div class="jumbotron">
				...
				<h4 style="margin-bottom: 25px;">A. Data Prediksi Retur Semua Produk Pada Periode Berikutnya </h4>
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-8">
							<form action="peramalan_semua_toko.php" method="post" name="ubah_alpha" class="form-inline" onsubmit="return submitForm();">
				...
				//rumus rata2 abs_err MAD
						...
						<script>
							...
							var dataFirst = {
								label: "Aktual",
								data: [<?php
									$querydaktual = "SELECT nama_toko, bln_thn, SUM(jumlah_retur) AS jumlah_retur
									FROM tb_retur1
									WHERE nama_toko = '$nama_toko'
									GROUP BY nama_toko, bln_thn
									ORDER BY bln_thn";
								...
								var dataSecond = {
									...
									var speedData = {
										labels: [<?php
											$queryPeriode = "SELECT nama_toko, bln_thn, SUM(jumlah_retur) AS jumlah_retur
											FROM tb_retur1
											WHERE nama_toko = '$nama_toko'
											GROUP BY nama_toko, bln_thn
											ORDER BY bln_thn";
