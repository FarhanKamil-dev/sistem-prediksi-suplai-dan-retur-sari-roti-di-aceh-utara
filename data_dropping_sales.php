			...
			<div class="jumbotron">
				...
				<div class="container">
					...
					<div class="pagination">
						...
						if ($page > 1) {
							$pagelink .= "<a href='data_dropping_sales.php?page=1'>First</a>";
							$prevpage = $page - 1;
							$pagelink .= "<a href='data_dropping_sales.php?page=$prevpage'>Prev</a>";
						}

						for ($i = max(1, $page - 3); $i <= min($page + 3, $total_pages); $i++) {
							if ($i == $page) {
								$pagelink .= "<a class='active' href='data_dropping_sales.php?page=$i'>$i</a>";
							} else {
								$pagelink .= "<a href='data_dropping_sales.php?page=$i'>$i</a>";
							}
						}

						if ($page < $total_pages) {
							$nextpage = $page + 1;
							$pagelink .= "<a href='data_dropping_sales.php?page=$nextpage'>Next</a>";
							$pagelink .= "<a href='data_dropping_sales.php?page=$total_pages'>Last</a>";
						}
