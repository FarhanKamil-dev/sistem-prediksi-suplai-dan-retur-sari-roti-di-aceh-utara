...
$querytampil = "Select * from tb_produk";
...
<body>
	...
	<div class="content-container">
		...
		<div class="container-fluid">
			...
			<div class="jumbotron">
				<h2 style="margin-bottom: 25px;">Data produk</h2>
				<?php
				...
				<div style="margin-bottom: 10px;">
					<a class="btn btn-primary" href="tambah_produk.php">Tambah Data</a>
				</div>
				<table class="table table-hover table-bordered">
						...
						<tr>
							...
							<td>
								<form action="edit_produk.php" method="post">
									<input type="hidden" name="kode_produk" value="<?php echo "$kode_produk[kode_produk]"; ?>">
									<input type="hidden" name="nama_produk" value="<?php echo "$kode_produk[nama_produk]"; ?>">
					...
					mysqli_free_result($resultquery);
											...
											$querytotal = "SELECT COUNT(*) as total FROM tb_produk";
										...
										<div class="pagination">
											...
											if ($page > 1) {
												$pagelink .= "<a href='data_produk.php?page=1'>First</a>";
												$prevpage = $page - 1;
												$pagelink .= "<a href='data_produk.php?page=$prevpage'>Prev</a>";
											}
					
											for ($i = max(1, $page - 3); $i <= min($page + 3, $total_pages); $i++) {
												if ($i == $page) {
													$pagelink .= "<a class='active' href='data_produk.php?page=$i'>$i</a>";
												} else {
													$pagelink .= "<a href='data_produk.php?page=$i'>$i</a>";
												}
											}
					
											if ($page < $total_pages) {
												$nextpage = $page + 1;
												$pagelink .= "<a href='data_produk.php?page=$nextpage'>Next</a>";
												$pagelink .= "<a href='data_produk.php?page=$total_pages'>Last</a>";
											}
