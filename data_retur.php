...
<head>
	<meta charset="UTF-8">
	<title>Data Retur - Sari Roti</title>
			...
			<div class="jumbotron">
				...
				<div class="container">
					<div style="margin-bottom: 10px;">
						<a class="btn btn-primary" href="tambah_retur.php">Tambah Data</a>
					</div>
					<div style="margin-bottom: 10px;">
					...
					<table class="table table-hover table-bordered">
						...
						while ($data = mysqli_fetch_assoc($resultquery)) {
							...
							<tr>
								...
								?>
								<td>
									<form action="edit_retur.php" method="post">
								...
								<td>
									<form action="hapus_retur.php" method="post">
										<input type="hidden" name="kode_retur" value="<?php echo "$data[kode_retur]"; ?>">
