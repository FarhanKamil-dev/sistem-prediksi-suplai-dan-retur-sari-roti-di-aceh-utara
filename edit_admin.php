...
if (isset($_POST["submit"])) {
	...
	if (empty($level_user)) {
		$pesan_error[]= "Level user belum di isi!";
	}
	...
	if ((!$pesan_error) AND ($_POST["submit"]=="Update Data")) {
		...
		$queryupdate .= "username = '$username', password = '$password',level_user = '$level_user' ";
			...
			<div class="jumbotron">
				...
				<form action="edit_admin.php" method="post" name="update_data">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="level_user" value="<?php echo $level_user;?>">
					</div>
					<div style="display: flex;">
						...
						<div style="margin: 20px 0px 0px 20px;">
							<a class="btn btn-danger" href="edit_admin.php">Batal</a>
						</div>
					</div>
				</form>
			</div>
