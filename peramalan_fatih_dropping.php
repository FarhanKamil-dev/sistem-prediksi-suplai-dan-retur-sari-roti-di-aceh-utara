...
WHERE d.nama_toko = 'fatih market'  AND p.kode_produk = '$nama_produk' 
	...
	if ($_POST["submit"]="Ganti Alpha") {
		...
		if (($pesan_error === "") AND ($_POST["submit"]="Ganti Alpha")) {
			...
			if ($resultquery) {
				...
				header("Location: peramalan_fatih_dropping.php?pesan_sukses={$pesan_sukses}");
			}
			else {
			...
			<div class="jumbotron">
				...
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form action="peramalan_fatih_dropping.php" method="post" name="ubah_alpha" class="form-inline" onsubmit="return submitForm();">
								<div class="form-group">
									<input type="text" class="form-control" name="nilai_alpha" id="nilai_alpha" placeholder="Ganti Nilai Alpha"style="margin-bottom: 10px;">
								</div>
