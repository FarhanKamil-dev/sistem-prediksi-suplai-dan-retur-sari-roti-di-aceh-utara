...
<head>
	<meta charset="UTF-8">
	<title>Data dropping - Sari Roti</title>
...
<body>
	...
	<div class="content-container">
		<div class="container-fluid">
			<div class="jumbotron">
				<h2 style="margin-bottom: 25px;">Data dropping</h2>
				<?php
				...
				<div class="container">
					<div style="margin-bottom: 10px;">
						<a class="btn btn-primary" href="tambah_dropping.php">Tambah Data</a>
					</div>
					<div style="margin-bottom: 10px;">
					...
					<table class="table table-hover table-bordered">
						...
						while ($data = mysqli_fetch_assoc($resultquery)) {
							...
							<tr>
								...
								?>
								<td>
									<form action="edit_dropping.php" method="post">
										<input type="hidden" name="kode_dropping" value="<?php echo "$data[kode_dropping]"; ?>">
										<input class="btn btn-primary" type="submit" name="submit" value="Edit">
									</form>
								</td>
								<td>
									<form action="hapus_dropping.php" method="post">
										<input type="hidden" name="kode_dropping" value="<?php echo "$data[kode_dropping]"; ?>">
					...
					<div class="pagination">
						...
						if ($page > 1) {
							$pagelink .= "<a href='data_dropping.php?page=1'>First</a>";
							$prevpage = $page - 1;
							$pagelink .= "<a href='data_dropping.php?page=$prevpage'>Prev</a>";
						}

						for ($i = max(1, $page - 3); $i <= min($page + 3, $total_pages); $i++) {
							if ($i == $page) {
								$pagelink .= "<a class='active' href='data_dropping.php?page=$i'>$i</a>";
							} else {
								$pagelink .= "<a href='data_dropping.php?page=$i'>$i</a>";
							}
						}
						
						if ($page < $total_pages) {
							$nextpage = $page + 1;
							$pagelink .= "<a href='data_dropping.php?page=$nextpage'>Next</a>";
						}
						
						$pagelink .= "<a href='data_dropping.php?page=$total_pages'>Last</a>";
