...
WHERE r.nama_toko = 'rafa jaya'  AND p.kode_produk = '$nama_produk' 
	...
	if ($_POST["submit"]="Ganti Alpha") {
		...
		if (($pesan_error === "") AND ($_POST["submit"]="Ganti Alpha")) {
			...
			if ($resultquery) {
				...
				header("Location: peramalan_rafa.php?pesan_sukses={$pesan_sukses}");
			}
			else {
...
<body>
	...
	<div class="content-container">
		<div class="container-fluid">
			...
			<div class="jumbotron">
				<h2 style="margin-bottom: 25px;">TOKO RAFA JAYA</h2>
				...
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form action="peramalan_rafa.php" method="post" name="ubah_alpha" class="form-inline" onsubmit="return submitForm();">
