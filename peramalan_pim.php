...
$querysum = "SELECT SUM(jumlah_retur) FROM tb_retur1 WHERE nama_toko = 'market pim'";
$pesan_error = "";
	...
	if ($_POST["submit"]="Ganti Alpha") {
		...
		if (($pesan_error === "") AND ($_POST["submit"]="Ganti Alpha")) {
			...
			if ($resultquery) {
				...
				header("Location: peramalan_pim.php?pesan_sukses={$pesan_sukses}");
			}
			else {
			...
			<div class="jumbotron">
				...
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-8">
							<form action="peramalan_pim.php" method="post" name="ubah_alpha">
