...
WHERE r.nama_toko = 'rayon baru toko'  AND p.kode_produk = '$nama_produk' 
...
FROM tb_retur1
WHERE nama_toko = 'rayon baru toko' 
...
<body>
	...
	<div class="content-container">
		<div class="container-fluid">
			...
			<div class="jumbotron">
				<h2 style="margin-bottom: 25px;">TOKO RAYON BARU</h2>
				...
				<div style="margin-bottom: 10px;">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form action="peramalan_rayon.php" method="post" name="ubah_alpha" class="form-inline" onsubmit="return submitForm();">
